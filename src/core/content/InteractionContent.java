...
public class InteractionContent extends Content
{
    ...
    public InteractionContent clone()
    {

        InteractionContent clonedInteractionContent = (InteractionContent)super.clone();
        clonedInteractionContent.object1 = this.object1;
        clonedInteractionContent.object2 = this.object2.clone();
        clonedInteractionContent.function = this.function;
        clonedInteractionContent.hashCode = this.hashCode;
        return clonedInteractionContent;
