...
public class SpriteContent extends Content
{
    ...
    public SpriteContent clone()
    {

        SpriteContent clonedSpriteContent = (SpriteContent)super.clone();
        clonedSpriteContent.referenceClass = this.referenceClass;
        clonedSpriteContent.itypes = (ArrayList<Integer>)this.itypes.clone();
        clonedSpriteContent.subtypes = (ArrayList<Integer>)this.subtypes.clone();
        return clonedSpriteContent;
