...
public class MappingContent extends Content
{
    ...
    public MappingContent clone()
    {

        MappingContent clonedMappingContent = (MappingContent)super.clone();
        clonedMappingContent.reference = (ArrayList<String>)this.reference.clone();
        clonedMappingContent.charId = new Character(this.charId.charValue());
        return clonedMappingContent;
