...
public class BasicGame extends Game {
    ...
    public BasicGame cloneExceptForwardModelAndRandom()
    {

        BasicGame clonedBasicGame = (BasicGame)super.cloneExceptForwardModelAndRandomAndPathFinder();
        clonedBasicGame.square_size = this.square_size;
        clonedBasicGame.obs = this.obs;
        clonedBasicGame.obstacles = new ArrayList<Integer>();
        clonedBasicGame.obstacles.addAll(this.obstacles);

        return clonedBasicGame;
