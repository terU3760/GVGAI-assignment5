 ...
 */
public class ArcadeMachineContinuousLearning
{
    ...
    public static AbstractPlayer m_playerOnceCreated = null;
    ...
    {
        String agentName = "controllers.learningmodel.DQNVanillaAgent";
                                    ...
                                    String agentName, String actionFile, int randomSeed, boolean isHuman)
    {
        ...
        //Create the player.
        AbstractPlayer player = ArcadeMachineContinuousLearning.createPlayer(agentName, actionFile, toPlay.getObservation(), randomSeed);
        ...
        if(! ArcadeMachineContinuousLearning.tearPlayerDown(toPlay, player) )
            return toPlay.handleResult();
     ...
     * @param isHuman indicates if a human is playing the game.
     */
    public static double runOneGameButCreatePlayerOnceOnly(String game_file, String level_file, boolean visuals,
                                    String agentName, String actionFile, int randomSeed, boolean isHuman)
    {
        VGDLFactory.GetInstance().init(); //This always first thing to do.
        VGDLRegistry.GetInstance().init();
        ...
        //Create the player.
        if(m_playerOnceCreated == null)
        {
            m_playerOnceCreated = ArcadeMachineContinuousLearning.createPlayer(agentName, actionFile, toPlay.getObservation(), randomSeed);
        }
        AbstractPlayer player = m_playerOnceCreated;
    ...
    public static double runOneGameButCreatePlayerOnceOnly(String game_file, String level_file, boolean visuals,
                                                           String agentName, int memoryInterval, int memoryLimit, int memoryWindowLength, boolean memoryIgnoreEpisodeBoundaries, double gamma, String actionFile, int targetModelUpdate, String dqnVanillaModelSavePath, int modelSaveInterval, int nbMaxEpisodeSteps, int nbStepsWarmup, int trainInterval, int backwardBatchSize, double optimizerAdamLearningRate, int currentStep, int randomSeed, boolean outputEveryStep, boolean isHuman)
    {
        VGDLFactory.GetInstance().init(); //This always first thing to do.
        VGDLRegistry.GetInstance().init();
        ...
        if(m_playerOnceCreated == null)
        {
            m_playerOnceCreated = ArcadeMachineContinuousLearning.createPlayer(agentName, actionFile, toPlay.getObservation(), memoryInterval, memoryLimit, memoryWindowLength, memoryIgnoreEpisodeBoundaries, targetModelUpdate, gamma, dqnVanillaModelSavePath, modelSaveInterval, nbMaxEpisodeSteps, nbStepsWarmup, trainInterval, backwardBatchSize, optimizerAdamLearningRate, currentStep, randomSeed, outputEveryStep);
        }
        else
        {
            m_playerOnceCreated.setStateObs(toPlay.getObservation());
        }
    ...
    public static double runOneGeneratedLevel(String gameFile, boolean visuals,
        ...
        //Warm the game up.
        ArcadeMachineContinuousLearning.warmUp(toPlay, CompetitionParameters.WARMUP_TIME);
    ...
    public static double replayGame(String game_file, String level_file, boolean visuals, String actionFile)
    {
        ...
        AbstractPlayer player = ArcadeMachineContinuousLearning.createPlayer(agentName, null, toPlay.getObservation(), -1);
                                ...
                                String agentName, String[] actionFiles)
    {
        ...
        for(String level_file : level_files)
        {
            ...
            for(int i = 0; i < level_times; ++i)
            {
                ...
                //Create the player.
                AbstractPlayer player = ArcadeMachineContinuousLearning.createPlayer(agentName, filename, toPlay.getObservation(), randomSeed);
                ...
                //Finally, when the game is over, we need to tear the player down.
                if(player != null) ArcadeMachineContinuousLearning.tearPlayerDown(toPlay, player);
    ...
    private static AbstractPlayer createPlayer(String playerName, String actionFile, StateObservation so, int memoryInterval, int memoryLimit, int memoryWindowLength, boolean memoryIgnoreEpisodeBoundaries, int targetModelUpdate, double gamma, String dqnVanillaModelSavePath, int modelSaveInterval, int nbMaxEpisodeSteps, int nbStepsWarmup, int trainInterval, int backwardBatchSize, double optimizerAdamLearningRate, int currentStep, int randomSeed, boolean outputEveryStep)
    {
        AbstractPlayer player = null;

        try{
            //create the controller.
            player = createController(playerName, so, memoryInterval, memoryLimit, memoryWindowLength, memoryIgnoreEpisodeBoundaries, gamma, targetModelUpdate, dqnVanillaModelSavePath, modelSaveInterval, nbMaxEpisodeSteps, nbStepsWarmup, trainInterval, backwardBatchSize, optimizerAdamLearningRate, currentStep, outputEveryStep);
            if(player != null)
                player.setup(actionFile, randomSeed);
    ...
    protected static AbstractPlayer createController(String playerName, StateObservation so, int memoryInterval, int memoryLimit, int memoryWindowLength, boolean memoryIgnoreEpisodeBoundaries, double gamma, int targetModelUpdate, String dqnVanillaModelSavePath, int modelSaveInterval, int nbMaxEpisodeSteps, int nbStepsWarmup, int trainInterval, int backwardBatchSize, double optimizerAdamLearningRate, int currentStep, boolean outputEveryStep) throws RuntimeException
    {
        AbstractPlayer player = null;
        try
        {
            //Get the class and the constructor with arguments (StateObservation, long).
            Class<? extends AbstractPlayer> controllerClass = Class.forName(playerName).asSubclass(AbstractPlayer.class);
            Class[] gameArgClass = new Class[]{StateObservation.class, ElapsedCpuTimer.class, int.class, int.class, int.class, boolean.class, double.class, int.class, String.class, int.class, int.class, int.class, int.class, int.class, double.class, int.class, boolean.class };
            Constructor controllerArgsConstructor = controllerClass.getConstructor(gameArgClass);
            ...
            //Call the constructor with the appropriate parameters.
            Object[] constructorArgs = new Object[] {so, ect.copy(), memoryInterval, memoryLimit, memoryWindowLength, memoryIgnoreEpisodeBoundaries, gamma, targetModelUpdate, dqnVanillaModelSavePath, modelSaveInterval, nbMaxEpisodeSteps, nbStepsWarmup, trainInterval, backwardBatchSize, optimizerAdamLearningRate, currentStep, outputEveryStep};
            player = (AbstractPlayer) controllerArgsConstructor.newInstance(constructorArgs);
