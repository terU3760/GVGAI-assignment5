...
public class MultiSpriteCounter extends Termination
{
    ...
    public MultiSpriteCounter clone()
    {

        MultiSpriteCounter clonedMultiSpriteCounter = (MultiSpriteCounter)super.clone();
        clonedMultiSpriteCounter.stype1 = this.stype1;
        clonedMultiSpriteCounter.stype2 = this.stype2;
        clonedMultiSpriteCounter.itype1 = this.itype1;
        clonedMultiSpriteCounter.itype2 = this.itype2;
        clonedMultiSpriteCounter.min = this.min;

        return clonedMultiSpriteCounter;
