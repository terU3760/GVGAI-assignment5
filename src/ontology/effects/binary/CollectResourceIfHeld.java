...
public class CollectResourceIfHeld extends Effect
{
    ...
    public CollectResourceIfHeld() {}

    @Override
    public CollectResourceIfHeld clone() throws CloneNotSupportedException
    {

        CollectResourceIfHeld clonedCollectResourceIfHeld = (CollectResourceIfHeld)super.clone();
        clonedCollectResourceIfHeld.killResource = this.killResource; //Only if the resource is collected.
        clonedCollectResourceIfHeld.heldResource = this.heldResource;
        clonedCollectResourceIfHeld.heldResourceId = this.heldResourceId;
        clonedCollectResourceIfHeld.value = this.value;
        return clonedCollectResourceIfHeld;
