...
public class AttractGaze extends Effect
{
    ...
    @Override
    public AttractGaze clone() throws CloneNotSupportedException
    {

        AttractGaze clonedAttractGaze = (AttractGaze)super.clone();
        clonedAttractGaze.align = this.align;
        return clonedAttractGaze;
