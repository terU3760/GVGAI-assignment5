...
public class TransformToSingleton extends Effect {
    ...
    @Override
    public TransformToSingleton clone() throws CloneNotSupportedException
    {

        TransformToSingleton clonedTransformToSingleton = (TransformToSingleton)super.clone();
        clonedTransformToSingleton.stype = this.stype;
        clonedTransformToSingleton.itype = this.itype;
        clonedTransformToSingleton.takeOrientation = this.takeOrientation;
        clonedTransformToSingleton.stype_other = this.stype_other;
        clonedTransformToSingleton.itype_other = this.itype_other;

        return clonedTransformToSingleton;
