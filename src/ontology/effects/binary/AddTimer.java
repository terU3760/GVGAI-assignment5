...
public class AddTimer extends TimeEffect
{
    ...
    @Override
    public AddTimer clone() throws CloneNotSupportedException
    {

        AddTimer clonedAddTimer = (AddTimer)super.clone();

        clonedAddTimer.delegate = this.delegate;
        clonedAddTimer.itype = this.itype;
        clonedAddTimer.isNative = this.isNative;

        return clonedAddTimer;
