...
public class KillIfFromAbove extends Effect
{
    ...
    @Override
    public KillIfFromAbove clone() throws CloneNotSupportedException
    {

        KillIfFromAbove clonedKillIfFromAbove = (KillIfFromAbove)super.clone();

        return clonedKillIfFromAbove;
