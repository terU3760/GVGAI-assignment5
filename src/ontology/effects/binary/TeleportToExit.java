...
public class TeleportToExit extends Effect
{
    ...
    @Override
    public TeleportToExit clone() throws CloneNotSupportedException
    {

        TeleportToExit clonedTeleportToExit = (TeleportToExit)super.clone();

        return clonedTeleportToExit;
