...
public class CollectResource extends Effect
{
    ...
    @Override
    public CollectResource clone() throws CloneNotSupportedException
    {

        CollectResource clonedCollectResource = (CollectResource)super.clone();
        clonedCollectResource.killResource = this.killResource;
        return clonedCollectResource;
