...
//                    " to " + newSprite + " after colliding with " + sprite2.getType());
    ...
    public TransformToAll() {}

    @Override
    public TransformToAll clone() throws CloneNotSupportedException
    {

        TransformToAll clonedTransformToAll = (TransformToAll)super.clone();
        clonedTransformToAll.stype2 = this.stype2;
        clonedTransformToAll.itype2 = this.itype2;

        return clonedTransformToAll;
