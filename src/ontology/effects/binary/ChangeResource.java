...
public class ChangeResource extends Effect
{
    ...
    @Override
    public ChangeResource clone() throws CloneNotSupportedException
    {

        ChangeResource clonedChangeResource = (ChangeResource)super.clone();
        clonedChangeResource.resource = this.resource;
        clonedChangeResource.resourceId = this.resourceId;
        clonedChangeResource.value = this.value;
        clonedChangeResource.killResource = this.killResource;
        return clonedChangeResource;
