...
public class KillIfNotFrontal extends Effect
{
    ...
    @Override
    public KillIfNotFrontal clone() throws CloneNotSupportedException
    {

        KillIfNotFrontal clonedKillIfNotFrontal = (KillIfNotFrontal)super.clone();

        return clonedKillIfNotFrontal;
