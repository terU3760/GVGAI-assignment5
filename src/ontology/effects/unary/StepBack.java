...
public class StepBack extends Effect
{
    ...
    @Override
    public StepBack clone() throws CloneNotSupportedException
    {

        StepBack clonedStepBack = (StepBack)super.clone();
        clonedStepBack.pixelPerfect = this.pixelPerfect;

        return clonedStepBack;
