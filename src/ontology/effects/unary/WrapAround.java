...
public class WrapAround extends Effect {
    ...
    @Override
    public WrapAround clone() throws CloneNotSupportedException
    {

        WrapAround clonedWrapAround = (WrapAround)super.clone();
        clonedWrapAround.offset = this.offset;

        return clonedWrapAround;
