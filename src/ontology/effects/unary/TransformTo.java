...
public class TransformTo extends Effect {
    ...
    @Override
    public TransformTo clone() throws CloneNotSupportedException
    {

        TransformTo clonedTransformTo = (TransformTo)super.clone();
        clonedTransformTo.stype = this.stype;
        clonedTransformTo.itype = this.itype;
        clonedTransformTo.killSecond = this.killSecond;

        return clonedTransformTo;
