...
public class SubtractHealthPoints extends Effect
{
    ...
    @Override
    public SubtractHealthPoints clone() throws CloneNotSupportedException
    {

        SubtractHealthPoints clonedSubtractHealthPoints = (SubtractHealthPoints)super.clone();
        clonedSubtractHealthPoints.value = this.value;
        clonedSubtractHealthPoints.limit = this.limit;

        return clonedSubtractHealthPoints;
