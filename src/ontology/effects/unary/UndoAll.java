...
public class UndoAll extends Effect
{
    ...
    @Override
    public UndoAll clone() throws CloneNotSupportedException
    {

        UndoAll clonedUndoAll = (UndoAll)super.clone();
        clonedUndoAll.notStype = this.notStype;
        clonedUndoAll.notItypes = new ArrayList<Integer>();
        for(Integer vs: this.notItypes)
        {
            clonedUndoAll.notItypes.add(new Integer(vs.intValue()));
        }

        return clonedUndoAll;
