...
public class TimeEffect extends Effect implements Comparable<TimeEffect> {
    ...
    @Override
    public TimeEffect clone() throws CloneNotSupportedException
    {

        TimeEffect clonedTimeEffect = (TimeEffect)super.clone();

        clonedTimeEffect.is_kill_effect = this.is_kill_effect;
        clonedTimeEffect.is_stochastic = this.is_stochastic;
        clonedTimeEffect.scoreChange = this.scoreChange;
        clonedTimeEffect.prob = this.prob;
        clonedTimeEffect.applyScore = this.applyScore;
        clonedTimeEffect.repeat = this.repeat;

        clonedTimeEffect.timer = this.timer;
        clonedTimeEffect.nextExecution = this.nextExecution;
        clonedTimeEffect.itype = this.itype;
        clonedTimeEffect.repeating = this.repeating;

        return clonedTimeEffect;
